...
typedef struct {
    ...
    size_t itemCount;          // Counts items in Knapsack, also serves as index for next item to be added.
    size_t itemCapacity;       // Capacity of the items array, used for memory management.
